...
env = make_vec_env(DiscreteEnv, n_envs=1, env_kwargs={"rendering_frequency": 200, "trial_name": trial_name})

model = PPO2(ReflectedPolicy, env, n_steps=1000, full_tensorboard_log=False, nminibatches=1, tensorboard_log=f'./Output/{trial_name}/ppo_tensorboard/')#, policy_kwargs={"data_format":"NCHW"})
